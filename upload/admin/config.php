<?php
// HTTP
define('HTTP_SERVER', 'http://opencart.local.dev/admin/');
define('HTTP_CATALOG', 'http://opencart.local.dev/');
define('HTTP_IMAGE', 'http://opencart.local.dev/image/');

// HTTPS
define('HTTPS_SERVER', 'http://opencart.local.dev/admin/');
define('HTTPS_CATALOG', 'http://opencart.local.dev/');
define('HTTPS_IMAGE', 'http://opencart.local.dev/image/');
...
define('DB_DATABASE', 'opencart_1.5.4.1');
define('DB_PREFIX', '');
?>